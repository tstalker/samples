...
void error_print(error_clist);
void token_print(cint);
void stoken_print(cpchar, cint);
void ptoken_print(cpint);
...
vector_t_int max2(vector_ct_int, vector_ct_int);
vector_t_int max3(vector_ct_int, vector_ct_int, vector_ct_int);
